...
0000000000400ee0 <phase_1>:
  ...
  400ee4:	be 00 24 40 00       	mov    $0x402400,%esi      // pass parameter through %esi, then check certain string with input
  400ee9:	e8 4a 04 00 00       	call   401338 <strings_not_equal> // another parameter passed through %rdi, which is unchanged
  400eee:	85 c0                	test   %eax,%eax            // explode if not equal, thus the string 0x402400 may be the key
...
0000000000400efc <phase_2>:
  ...
  400f0a:	83 3c 24 01          	cmpl   $0x1,(%rsp)  // start at 1
  400f0e:	74 20                	je     400f30 <phase_2+0x34>
  400f10:	e8 25 05 00 00       	call   40143a <explode_bomb>
  400f15:	eb 19                	jmp    400f30 <phase_2+0x34>
  400f17:	8b 43 fc             	mov    -0x4(%rbx),%eax ++++++++ loop jump here!
  400f1a:	01 c0                	add    %eax,%eax    // double to previous
  400f1c:	39 03                	cmp    %eax,(%rbx)  // check equals. means current value should be double to the previous
  400f1e:	74 05                	je     400f25 <phase_2+0x29>
  400f20:	e8 15 05 00 00       	call   40143a <explode_bomb>
  400f25:	48 83 c3 04          	add    $0x4,%rbx           ------ loop iterate
  400f29:	48 39 eb             	cmp    %rbp,%rbx            ------ loop condition 
  400f2c:	75 e9                	jne    400f17 <phase_2+0x1b> ++++++++ loop jump
  400f2e:	eb 0c                	jmp    400f3c <phase_2+0x40>
  400f30:	48 8d 5c 24 04       	lea    0x4(%rsp),%rbx     ------ loop initialization, start at 0x4(%rsp)
  400f35:	48 8d 6c 24 18       	lea    0x18(%rsp),%rbp    ------ loop initialization, end at 0x18(%rsp)
  400f3a:	eb db                	jmp    400f17 <phase_2+0x1b>
  400f3c:	48 83 c4 28          	add    $0x28,%rsp ------------- recover stack 
  400f40:	5b                   	pop    %rbx
  400f41:	5d                   	pop    %rbp
  400f42:	c3                   	ret    
...
0000000000400f43 <phase_3>:
  ...
  400f47:	48 8d 4c 24 0c       	lea    0xc(%rsp),%rcx         // sscanf output address
  400f4c:	48 8d 54 24 08       	lea    0x8(%rsp),%rdx         // sscanf output address
  400f51:	be cf 25 40 00       	mov    $0x4025cf,%esi         // format string. buffer is in %rdi
  400f56:	b8 00 00 00 00       	mov    $0x0,%eax
  400f5b:	e8 90 fc ff ff       	call   400bf0 <__isoc99_sscanf@plt>
  400f60:	83 f8 01             	cmp    $0x1,%eax              
  400f63:	7f 05                	jg     400f6a <phase_3+0x27>  // ssacnf parse successed
  400f65:	e8 d0 04 00 00       	call   40143a <explode_bomb>
  400f6a:	83 7c 24 08 07       	cmpl   $0x7,0x8(%rsp)         // test first scan 0x8(%rsp) - 0x7 > 0 ?
...
0000000000401338 <strings_not_equal>:
  ...
  40133a:	55                   	push   %rbp
  40133b:	53                   	push   %rbx
  40133c:	48 89 fb             	mov    %rdi,%rbx              // first parameter %rdi -> rbx
  40133f:	48 89 f5             	mov    %rsi,%rbp              // second parameter %rsi -> %rbp
  ...
  401357:	41 39 c4             	cmp    %eax,%r12d             // comp two string
  40135a:	75 3f                	jne    40139b <strings_not_equal+0x63>
  40135c:	0f b6 03             	movzbl (%rbx),%eax            // read the first char
  ...
  401372:	48 83 c3 01          	add    $0x1,%rbx // next char
  401376:	48 83 c5 01          	add    $0x1,%rbp // next char
